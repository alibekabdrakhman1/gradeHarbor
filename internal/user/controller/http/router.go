...
func (s *Server) SetupRoutes() {
	...
	v1.DELETE("/profile/delete", s.handler.User.Delete)
	...
	v1.GET("/profile/:id/grades", s.handler.User.GetStudentGradesByID, s.jwt.ValidateParent, s.jwt.ValidateTeacher)
	v1.GET("/profile/:id/parent", s.handler.User.GetStudentParentByID, s.jwt.ValidateTeacher)
	v1.GET("/profile/:id/children", s.handler.User.GetParentChildrenByID, s.jwt.ValidateTeacher)
	...
	admin.DELETE("/user/delete/:id", s.handler.Admin.DeleteUser)
