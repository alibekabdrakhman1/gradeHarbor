...
func (s *Server) SetupRoutes() {
	...
	userClass.GET("/:id", s.handler.Class.GetClassByID)                                      //TODO returns my grades
	userClass.POST("/:id/grades", s.handler.Class.PutClassGradesByID, s.jwt.ValidateTeacher) //TODO post grades to class by class_id
	userClass.GET("/:id/students", s.handler.Class.GetClassStudentsByID)                     //TODO returns class students
	userClass.GET("/:id/grades", s.handler.Class.GetClassGradesByID)                         //TODO returns all grades by class_id
	...
	adminClass.GET("/", s.handler.Admin.GetAllClasses)      //TODO getAll userClass new class needs to do search and filter
